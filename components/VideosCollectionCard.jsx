...
const Videos = ({ item }) => {
    return (
        ...
        <View className='h-24 mx-4 flex-row relative'>
            ...
            />
            <View
                className='absolute bg-cardBg-200 h-8 rounded-tl-xl rounded-b-md rounded-tr-md items-center justify-center'>
            ...
            <View className='flex-col ml-5'>
                <TouchableOpacity onPress={() => router.push(`/video/${item.id}`)}>
                    <Text className='text-text-100 font-bold text-lg mb-3' ellipsizeMode="tail"
